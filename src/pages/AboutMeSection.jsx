...
function AboutMeSection() {
  ...
  <section id='about'>
    ...
    <div className="aboutMe_container flex pt-6 justify-center gap-2">
        <div className="about_left_card  rounded-lg card-bordered h-96  shadow-2xl">
            <div className="p-4  h-72 flex flex-col  justify-center">
        ...
        <div className="about_left_card  rounded-lg card-bordered max-h-fit w-2/4 shadow-2xl">
